...
def test_grammar(grammarfile, testfile):
    print(f'grammarfile: {grammarfile}')
...
if __name__=='__main__':
    ...
    if 'help' in sys.argv:
        ...
        print(f'Feature File: {featurefile}')
        print(f'Learning Data: {datafile}')
        print(f'Testing Data: {testfile}')
        if datachecker.findOrphans(datafile, featurefile, verbose=True):
            ...
            if 'baseline' in sys.argv:
                ...
                try:
                    ...
                    print("Done! look for your results in the simulation folder:")
                    print(outdir)
                except IndexError:
                    print(HelpMessage)
